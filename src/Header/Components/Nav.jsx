    ...
    return (
        <nav className="z-50 text-[#EEEEEE] flex">
            ...
            <div className={`fixed inset-0 absolute block pl-8 pt-2 top-20 w-full left-0 right-0 bg-[#111111] flex flex-col ${isOpen ? 'block' : 'hidden'} md:flex md:items-center md:relative md:inset-auto md:flex-row`}>
                ...
                <a href="#Movies" className="mb-2 mr-2 text-xl lg:font-semibold md:font-semibold md:mb-0 md:text-base lg:mb-0 lg:text-base hover:duration-300 hover:text-white">Movies</a>
                <a href="#Tvshows" className="text-xl md:text-base md:font-semibold lg:text-base lg:font-semibold hover:duration-300 hover:text-white">TV shows</a>
            </div>
        </nav>
    )
}