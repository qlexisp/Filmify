            ...
            <div className="bg-[#191919] h-full">
                ...
                {movie ? (
                    <div className="flex flex-col my-8 lg:flex-row lg:mx-20">
                        <img src={movie.poster_path ? `https://image.tmdb.org/t/p/w500${movie.poster_path}` : 'https://filmify-alpha.vercel.app/assets/poster_unavailable.jpg'} alt={movie.title} className="flex-none mx-auto rounded-lg w-[90%] h-[90%] mb-6 lg:w-[325px] lg:h-auto object-contain" />
                        <div className="">
